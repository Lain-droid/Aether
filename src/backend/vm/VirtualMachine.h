...
namespace AetherVisor {
    namespace VM {
        ...
        public:
            ...
            VMException GetException() const { return m_current_exception; }
            void ClearException();
        ...
        private:
            ...
            bool ExecutePushInt();
            bool ExecutePushFloat();
            bool ExecutePushDouble();
            bool ExecutePushString();
            bool ExecutePushConst();
            bool ExecutePop();
            bool ExecuteDup();
            bool ExecuteSwap();
            bool ExecuteLoadLocal();
            bool ExecuteStoreLocal();
            bool ExecuteLoadGlobal();
            bool ExecuteStoreGlobal();
            
            bool ExecuteAdd();
            bool ExecuteSubtract();
            bool ExecuteMultiply();
            bool ExecuteDivide();
            bool ExecuteModulo();
            bool ExecuteNegate();
            bool ExecuteIncrement();
            bool ExecuteDecrement();
            
            bool ExecuteBitwiseAnd();
            bool ExecuteBitwiseOr();
            bool ExecuteBitwiseXor();
            bool ExecuteBitwiseNot();
            bool ExecuteShiftLeft();
            bool ExecuteShiftRight();
            
            bool ExecuteLogicalAnd();
            bool ExecuteLogicalOr();
            bool ExecuteLogicalNot();
            
            bool ExecuteCompareEqual();
            bool ExecuteCompareNotEqual();
            bool ExecuteCompareGreater();
            bool ExecuteCompareGreaterEqual();
            bool ExecuteCompareLess();
            bool ExecuteCompareLessEqual();
            
            bool ExecuteJump();
            bool ExecuteJumpIfZero();
            bool ExecuteJumpIfNotZero();
            bool ExecuteCall();
            bool ExecuteReturn();
            ...
            bool ExecuteArrayNew();
            bool ExecuteArrayGet();
            bool ExecuteArraySet();
            bool ExecuteArrayLength();
            
            bool ExecuteStringConcat();
            bool ExecuteStringLength();
            bool ExecuteStringSubstring();
            bool ExecuteStringCompare();
            
            bool ExecuteCastInt();
            bool ExecuteCastFloat();
            bool ExecuteCastString();
            bool ExecuteTypeOf();
            ...
            bool ExecuteCallNative();
            bool ExecuteLoadNative();
            bool ExecuteGetNativeFunc();
            
            bool ExecuteEncrypt();
            bool ExecuteDecrypt();
            bool ExecuteHash();
            bool ExecuteRandom();
            bool ExecuteObfuscate();
            bool ExecuteAntiDebug();
            bool ExecuteAntiVM();
            
            bool ExecuteJITCompile();
            bool ExecuteJITExecute();
            bool ExecuteProfile();
            ...
            bool ExecuteResume();
            bool ExecuteReset();
            bool ExecuteDebugBreak();
        };

        // VM factory for secure instantiation
        class VMFactory {
        public:
